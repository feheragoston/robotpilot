...
node_Servo::node_Servo(void) : node(SERVO_ID, "node_Servo", SERVO_KEEP_ALIVE_MS, SERVO_SEND_PERIOD_TO_PC_MS, SERVO_SEND_PERIOD_TO_NODE_MS){
	...
	//----- valtozo init ELEJE -----
	Servo_Deg_Incr_x0[SERVO_LEFT_GRIPPER_INDEX]				= SERVO_LEFT_GRIPPER_DEG_INCR_X0;
	Servo_Deg_Incr_y0[SERVO_LEFT_GRIPPER_INDEX]				= SERVO_LEFT_GRIPPER_DEG_INCR_Y0;
	Servo_Deg_Incr_x1[SERVO_LEFT_GRIPPER_INDEX]				= SERVO_LEFT_GRIPPER_DEG_INCR_X1;
	Servo_Deg_Incr_y1[SERVO_LEFT_GRIPPER_INDEX]				= SERVO_LEFT_GRIPPER_DEG_INCR_Y1;
	Servo_Deg_Incr_grad[SERVO_LEFT_GRIPPER_INDEX]			= SERVO_GET_GRAD(SERVO_LEFT_GRIPPER_INDEX);
	Servo_Deg_Incr_grad[SERVO_LEFT_GRIPPER_INDEX]			= SERVO_GET_GRAD(SERVO_LEFT_GRIPPER_INDEX);
	Servo_Limit_Low_Pos_Incr[SERVO_LEFT_GRIPPER_INDEX]		= SERVO_LEFT_GRIPPER_LIMIT_LOW_POS_INCR;
	Servo_Limit_High_Pos_Incr[SERVO_LEFT_GRIPPER_INDEX]		= SERVO_LEFT_GRIPPER_LIMIT_HIGH_POS_INCR;
	Servo_Limit_Current_Ma[SERVO_LEFT_GRIPPER_INDEX]		= SERVO_LEFT_GRIPPER_LIMIT_CURRENT_MA;

	Servo_Deg_Incr_x0[SERVO_RIGHT_GRIPPER_INDEX]			= SERVO_RIGHT_GRIPPER_DEG_INCR_X0;
	Servo_Deg_Incr_y0[SERVO_RIGHT_GRIPPER_INDEX]			= SERVO_RIGHT_GRIPPER_DEG_INCR_Y0;
	Servo_Deg_Incr_x1[SERVO_RIGHT_GRIPPER_INDEX]			= SERVO_RIGHT_GRIPPER_DEG_INCR_X1;
	Servo_Deg_Incr_y1[SERVO_RIGHT_GRIPPER_INDEX]			= SERVO_RIGHT_GRIPPER_DEG_INCR_Y1;
	Servo_Deg_Incr_grad[SERVO_RIGHT_GRIPPER_INDEX]			= SERVO_GET_GRAD(SERVO_RIGHT_GRIPPER_INDEX);
	Servo_Limit_Low_Pos_Incr[SERVO_RIGHT_GRIPPER_INDEX]		= SERVO_RIGHT_GRIPPER_LIMIT_LOW_POS_INCR;
	Servo_Limit_High_Pos_Incr[SERVO_RIGHT_GRIPPER_INDEX]	= SERVO_RIGHT_GRIPPER_LIMIT_HIGH_POS_INCR;
	Servo_Limit_Current_Ma[SERVO_RIGHT_GRIPPER_INDEX]		= SERVO_RIGHT_GRIPPER_LIMIT_CURRENT_MA;

	Servo_Deg_Incr_x0[SERVO_LEFT_CLAW_INDEX]					= SERVO_LEFT_CLAW_DEG_INCR_X0;
	Servo_Deg_Incr_y0[SERVO_LEFT_CLAW_INDEX]					= SERVO_LEFT_CLAW_DEG_INCR_Y0;
	Servo_Deg_Incr_x1[SERVO_LEFT_CLAW_INDEX]					= SERVO_LEFT_CLAW_DEG_INCR_X1;
	Servo_Deg_Incr_y1[SERVO_LEFT_CLAW_INDEX]					= SERVO_LEFT_CLAW_DEG_INCR_Y1;
	Servo_Deg_Incr_grad[SERVO_LEFT_CLAW_INDEX]				= SERVO_GET_GRAD(SERVO_LEFT_CLAW_INDEX);
	Servo_Limit_Low_Pos_Incr[SERVO_LEFT_CLAW_INDEX]			= SERVO_LEFT_CLAW_LIMIT_LOW_POS_INCR;
	Servo_Limit_High_Pos_Incr[SERVO_LEFT_CLAW_INDEX]			= SERVO_LEFT_CLAW_LIMIT_HIGH_POS_INCR;
	Servo_Limit_Current_Ma[SERVO_LEFT_CLAW_INDEX]			= SERVO_LEFT_CLAW_LIMIT_CURRENT_MA;

	Servo_Deg_Incr_x0[SERVO_RIGHT_CLAW_INDEX]				= SERVO_RIGHT_CLAW_DEG_INCR_X0;
	Servo_Deg_Incr_y0[SERVO_RIGHT_CLAW_INDEX]				= SERVO_RIGHT_CLAW_DEG_INCR_Y0;
	Servo_Deg_Incr_x1[SERVO_RIGHT_CLAW_INDEX]				= SERVO_RIGHT_CLAW_DEG_INCR_X1;
	Servo_Deg_Incr_y1[SERVO_RIGHT_CLAW_INDEX]				= SERVO_RIGHT_CLAW_DEG_INCR_Y1;
	Servo_Deg_Incr_grad[SERVO_RIGHT_CLAW_INDEX]				= SERVO_GET_GRAD(SERVO_RIGHT_CLAW_INDEX);
	Servo_Limit_Low_Pos_Incr[SERVO_RIGHT_CLAW_INDEX]			= SERVO_RIGHT_CLAW_LIMIT_LOW_POS_INCR;
	Servo_Limit_High_Pos_Incr[SERVO_RIGHT_CLAW_INDEX]		= SERVO_RIGHT_CLAW_LIMIT_HIGH_POS_INCR;
	Servo_Limit_Current_Ma[SERVO_RIGHT_CLAW_INDEX]			= SERVO_RIGHT_CLAW_LIMIT_CURRENT_MA;

	Servo_Deg_Incr_x0[SERVO_ARM_INDEX]					= SERVO_ARM_DEG_INCR_X0;
	Servo_Deg_Incr_y0[SERVO_ARM_INDEX]					= SERVO_ARM_DEG_INCR_Y0;
	Servo_Deg_Incr_x1[SERVO_ARM_INDEX]					= SERVO_ARM_DEG_INCR_X1;
	Servo_Deg_Incr_y1[SERVO_ARM_INDEX]					= SERVO_ARM_DEG_INCR_Y1;
	Servo_Deg_Incr_grad[SERVO_ARM_INDEX]					= SERVO_GET_GRAD(SERVO_ARM_INDEX);
	Servo_Limit_Low_Pos_Incr[SERVO_ARM_INDEX]			= SERVO_ARM_LIMIT_LOW_POS_INCR;
	Servo_Limit_High_Pos_Incr[SERVO_ARM_INDEX]			= SERVO_ARM_LIMIT_HIGH_POS_INCR;
	Servo_Limit_Current_Ma[SERVO_ARM_INDEX]				= SERVO_ARM_LIMIT_CURRENT_MA;
