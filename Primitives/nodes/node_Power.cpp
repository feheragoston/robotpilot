...
void node_Power::INIT_PARAM(void){
	...
	SET_U16(&(msg.data[11]), POWER_V_TO_ANALOG(POWER_ACCU_VOLTAGE_OK_LEVEL));

	SET_U16(&(msg.data[13]), POWER_V_TO_ANALOG(POWER_CHARGE_VOLTAGE_READY_LEVEL));
	SET_U16(&(msg.data[15]), POWER_V_TO_ANALOG(POWER_CHARGE_VOLTAGE_PLUGGED_IN_LEVEL));
