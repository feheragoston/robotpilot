...
#define INPUT_DIGITAL_START_BUTTON_INDEX					0
#define INPUT_DIGITAL_START_BUTTON_ACTIVE_LEVEL				0

#define INPUT_DIGITAL_COLOR_BUTTON_INDEX					1
#define INPUT_DIGITAL_COLOR_BUTTON_ACTIVE_LEVEL				0
...
#define INPUT_DIGITAL_PLUS_2_INDEX							6
