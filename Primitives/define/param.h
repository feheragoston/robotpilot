...
#define INPUT_DIGITAL_COLOR_RED_BUTTON_INDEX				7
#define INPUT_DIGITAL_COLOR_PURPLE_BUTTON_INDEX				2
...
#define INPUT_DIGITAL_COLOR_RED_BUTTON_ACTIVE_LEVEL			1
#define INPUT_DIGITAL_COLOR_PURPLE_BUTTON_ACTIVE_LEVEL		1
...
#define SERVO_LEFT_GRIPPER_INDEX						1
#define SERVO_RIGHT_GRIPPER_INDEX						0
#define SERVO_LEFT_CLAW_INDEX							3
#define SERVO_RIGHT_CLAW_INDEX							2
#define SERVO_ARM_INDEX									4
#define SERVO_PLUS_0_INDEX								5


#define SERVO_LEFT_GRIPPER_DEG_INCR_X0					0
#define SERVO_LEFT_GRIPPER_DEG_INCR_Y0					1136	//ok
#define SERVO_LEFT_GRIPPER_DEG_INCR_X1					90
#define SERVO_LEFT_GRIPPER_DEG_INCR_Y1					2073	//ok
#define SERVO_LEFT_GRIPPER_LIMIT_LOW_POS_INCR			1030	//ok	//-10deg
#define SERVO_LEFT_GRIPPER_LIMIT_HIGH_POS_INCR			2335	//ok	//+115deg
#define SERVO_LEFT_GRIPPER_LIMIT_CURRENT_MA				500		//mA

#define SERVO_RIGHT_GRIPPER_DEG_INCR_X0					0
#define SERVO_RIGHT_GRIPPER_DEG_INCR_Y0					1875	//ok
#define SERVO_RIGHT_GRIPPER_DEG_INCR_X1					90
#define SERVO_RIGHT_GRIPPER_DEG_INCR_Y1					990		//ok
#define SERVO_RIGHT_GRIPPER_LIMIT_LOW_POS_INCR			740		//ok	//+115deg
#define SERVO_RIGHT_GRIPPER_LIMIT_HIGH_POS_INCR			1975	//ok	//-10deg
#define SERVO_RIGHT_GRIPPER_LIMIT_CURRENT_MA			500		//mA

#define SERVO_LEFT_CLAW_DEG_INCR_X0						0
#define SERVO_LEFT_CLAW_DEG_INCR_Y0						1021	//ok, fuggoleges
#define SERVO_LEFT_CLAW_DEG_INCR_X1						90
#define SERVO_LEFT_CLAW_DEG_INCR_Y1						1802	//ok, vizszintes
#define SERVO_LEFT_CLAW_LIMIT_LOW_POS_INCR				1020	//ok
#define SERVO_LEFT_CLAW_LIMIT_HIGH_POS_INCR				2200	//ok
#define SERVO_LEFT_CLAW_LIMIT_CURRENT_MA				500		//mA

#define SERVO_RIGHT_CLAW_DEG_INCR_X0					0
#define SERVO_RIGHT_CLAW_DEG_INCR_Y0					1812	//ok, fuggoleges
#define SERVO_RIGHT_CLAW_DEG_INCR_X1					90
#define SERVO_RIGHT_CLAW_DEG_INCR_Y1					1066	//ok, vizszintes
#define SERVO_RIGHT_CLAW_LIMIT_LOW_POS_INCR				700		//ok
#define SERVO_RIGHT_CLAW_LIMIT_HIGH_POS_INCR			1820	//ok
#define SERVO_RIGHT_CLAW_LIMIT_CURRENT_MA				500		//mA

#define SERVO_ARM_DEG_INCR_X0							0
#define SERVO_ARM_DEG_INCR_Y0							1000
#define SERVO_ARM_DEG_INCR_X1							180
#define SERVO_ARM_DEG_INCR_Y1							2000
#define SERVO_ARM_LIMIT_LOW_POS_INCR					700
#define SERVO_ARM_LIMIT_HIGH_POS_INCR					2200
...
#define CONSOLE_CONTOLLER_LIMIT_LOW_POS_INCR		2500
#define CONSOLE_CONTOLLER_LIMIT_HIGH_POS_INCR		15000	//???
#define CONSOLE_HARDWARE_LIMIT_LOW_POS_INCR			123		//1mm
#define CONSOLE_HARDWARE_LIMIT_HIGH_POS_INCR		15561	//120mm
...
#define CONSOLE_MOTOR_PLUS_UP						0
