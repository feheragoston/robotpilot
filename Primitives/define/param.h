...
#define INPUT_PULLUP_DIGITAL_0					1
#define INPUT_PULLUP_DIGITAL_1					1
#define INPUT_PULLUP_DIGITAL_2					1
#define INPUT_PULLUP_DIGITAL_3					1
#define INPUT_PULLUP_DIGITAL_4					1
#define INPUT_PULLUP_DIGITAL_5					1
...
#define SERVO_0_DEG_INCR_GRAD				((double)(SERVO_0_DEG_INCR_Y1 - SERVO_0_DEG_INCR_Y0) / (SERVO_0_DEG_INCR_X1 - SERVO_0_DEG_INCR_X0))
...
#define SERVO_1_DEG_INCR_GRAD				((double)(SERVO_1_DEG_INCR_Y1 - SERVO_1_DEG_INCR_Y0) / (SERVO_1_DEG_INCR_X1 - SERVO_1_DEG_INCR_X0))
...
#define SERVO_2_DEG_INCR_GRAD				((double)(SERVO_2_DEG_INCR_Y1 - SERVO_2_DEG_INCR_Y0) / (SERVO_2_DEG_INCR_X1 - SERVO_2_DEG_INCR_X0))
...
#define SERVO_3_DEG_INCR_GRAD				((double)(SERVO_3_DEG_INCR_Y1 - SERVO_3_DEG_INCR_Y0) / (SERVO_3_DEG_INCR_X1 - SERVO_3_DEG_INCR_X0))
...
#define SERVO_4_DEG_INCR_GRAD				((double)(SERVO_4_DEG_INCR_Y1 - SERVO_4_DEG_INCR_Y0) / (SERVO_4_DEG_INCR_X1 - SERVO_4_DEG_INCR_X0))
...
#define SERVO_5_DEG_INCR_GRAD				((double)(SERVO_5_DEG_INCR_Y1 - SERVO_5_DEG_INCR_Y0) / (SERVO_5_DEG_INCR_X1 - SERVO_5_DEG_INCR_X0))
