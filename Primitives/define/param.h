...
//franciaorszagban
#define DEADRECK_WHEEL_DISTANCE_REC					((double)1 / 265.817833)
#define DEADRECK_LEFT_ONE_INCREMENT_DISTANCE		((double)1 / 67.331558)
#define DEADRECK_RIGHT_ONE_INCREMENT_DISTANCE		((double)1 / 67.13016)
