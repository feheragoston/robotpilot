...
#define DEADRECK_WHEEL_DISTANCE_REC					((double)1 / DEADRECK_WHEEL_DISTANCE)
#define DEADRECK_LEFT_ONE_INCREMENT_DISTANCE		0.01538
#define DEADRECK_RIGHT_ONE_INCREMENT_DISTANCE		0.01538
